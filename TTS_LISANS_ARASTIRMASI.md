...
- ☐ Fish Audio **ticari self-host** lisansı var mı, fiyatı? (Yol B seçilirse fish.audio'ya sor.)
- ☐ Piper Türkçe sesleri (dfki/fahrettin/fettah) **ses modeli** lisansı ticari uygun mu? (MODEL_CARD)
- ☐ Ses: ekip üyesi + izin belgesi tamam mı?
